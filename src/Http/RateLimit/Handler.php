...
namespace Zyh\ApiServer\Http\RateLimit;

use Zyh\ApiServer\Http\Request;
use Illuminate\Cache\CacheManager;
use Illuminate\Support\Collection;
use Illuminate\Container\Container;
use Zyh\ApiServer\Http\RateLimit\Throttle\Route;
use Zyh\ApiServer\Contract\Http\RateLimit\Throttle;
use Zyh\ApiServer\Contract\Http\RateLimit\HasRateLimiter;
...
class Handler
{
     ...
     *
     * @var \Zyh\ApiServer\Contract\Http\RateLimit\Throttle
     */
    protected $throttle;
     ...
     *
     * @param string|\Zyh\ApiServer\Contract\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
     ...
     *
     * @return \Zyh\ApiServer\Contract\Http\RateLimit\Throttle
     */
     ...
     *
     * @param callable|\Zyh\ApiServer\Http\RateLimit\Throttle $throttle
     *
     * @return void
     */
