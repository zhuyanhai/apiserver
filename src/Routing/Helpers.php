...
use Zyh\ApiServer\Http\Response\Factory;

/**
 * @property \Zyh\ApiServer\Dispatcher                                            $api
 * @property \Illuminate\Auth\GenericUser|\Illuminate\Database\Eloquent\Model $user
 * @property \Zyh\ApiServer\Auth\Auth                                             $auth
 * @property \Zyh\ApiServer\Http\Response\Factory                                 $response
 */
trait Helpers
{
    /**
     ...
     *
     * @param string|\Zyh\ApiServer\Contract\Http\RateLimit\Throttle $class
     * @param array                                              $options
     *
     * @return void
     */
